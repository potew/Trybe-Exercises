...
class LinkedList:
    ...
    def insert_first(self, value):
        ...
        #  Resumindo, o next será preenchido com o valor que está atualmente em head_value, para que o novo valor, que estamos inserindo no início da lista, seja preenchido na variável head_value, se tornando a "cabeça" da lista.
        # Caso contrário o elemento anterior seria sobresposto pelos novos
