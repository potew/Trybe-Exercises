...
# get_most_ordered_dish_per_costumer é uma função que retorna o prato mais pedido por um determinado cliente, considerando que os pedidos estão em uma lista.

# get_order_frequency_per_costumer é uma função que retorna a frequência que um determinado cliente pede um determinado prato, considerando que os pedidos estão em uma lista.
...
# estamos adicionando a fixture orders ao teste, ou seja, temos um contexto onde os pedidos são os definidos anteriormente
