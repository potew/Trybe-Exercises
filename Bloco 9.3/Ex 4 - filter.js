...
const filterPeople = (pessoas) => {
    return pessoas.filter( ({ bornIn, nationality } = pessoas) => (bornIn < 2001 && nationality === 'Australian') );
}

/* Assim também roda:
const filterPeople = (pessoas) => {
    return pessoas.filter((pessoa) => (pessoa.bornIn < 2001 && pessoa.nationality === 'Australian'));
}*/
